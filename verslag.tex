...
\usepackage[usenames]{xcolor} % to change color in code listings
...
\lstset{
  ...
  backgroundcolor=\color[HTML]{D6D6D6},
  commentstyle=\color[HTML]{1A9E00},
  keepspaces=true, 
  language=Haskell,
...
\newcommand{\inlinecode}{\lstinline[basicstyle=\ttfamily,keywordstyle={}]}
