...
\end{lstlisting}
\label{fig:voorbeeldcode_eventhandler}
\caption{Voorbeeldcode eventhandler}
...
\todo{aanpasssen dat we meer uitleg over het concept hebben, zodat veel termen niet in het detailontwerp voor het eerst langskomen. Het deailtontwerp leest nu teveel als een globaalontwerp met allemaal ontwerpkeuzes erdoorheen gestrooid, kort vertellen over gebruik libries als KineticJS e.d.}