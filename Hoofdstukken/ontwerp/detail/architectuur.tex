...
Gegevensoverdracht tussen de HTTP server en de browser moet snel gebeuren. Vanuit de module ontvangt de client de grafische elementen die getekend moeten worden. De gebruiker moet geen vertraging ervaren in de grafische interface.
...
Het protocol tussen de client en de server bevat voornamelijk interface data. De structuur en de attributen moeten vertaald worden van de Haskell omgeving om gebruikt te worden om te tekenen in het Canvas en vervolgens input van de gebruiker in de browseromgeving te ondersteunen. Voor optimale performance word de structuur zo snel mogelijk vertaald naar de structuur van KineticJS.

-Ondersteunen van acties in het protocol
