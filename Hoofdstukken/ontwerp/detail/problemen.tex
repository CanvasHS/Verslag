...
\paragraph{Systeemtoetsen} Echter zijn er een aantal zaken waar systemen zo in verschillen dat we deze niet voor alle mogelijke systemen hebben afgevangen in Canvas.hs. Er zijn bijvoorbeeld grote verschillen in de toetsenborden tussen verschillende systemen. Zo heeft windows een windows-toets, OSX een command-toets en hebben de meeste linux distributies überhaupt geen toets met soortgelijke werking, we hebben er in Canvas.hs voor gekozen al deze toetsen onder de naam 'superkey' te scharen.
