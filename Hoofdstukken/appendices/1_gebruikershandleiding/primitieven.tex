...
Deingedrukte toets wordt weergegeven met een \type{String}. Deze bevat een omschrijving van de ingedrukte toets, bijvoorbeeld \inlinecode{"a"}, \inlinecode{"E"} of \inlinecode{"1"} maar ook \inlinecode{"backspace"}, \inlinecode{"shift"} of \inlinecode{"F12"}.
