...
\begin{itemize}
	...
	\item \type{String}, het id van de \shape waarop gestopt werd met slepen {\color{red} WAT ALS GESTOPT WORD MET SLEPEN OP EEN SHAPE DIE DAAR NIET IN GEINTERESSERD IS, OF UBERHAUPT GEEN ID HEEFT?}
\end{itemize}
...
Deingedrukte toets wordt weergegeven met een \type{String}. Deze bevat een omschrijving van de ingedrukte toets, bijvoorbeeld \inlinecodequotes{"a"}, \inlinecodequotes{"E"} of \inlinecodequotes{"1"} maar ook \inlinecodequotes{"backspace"}, \inlinecodequotes{"shift"} of \inlinecodequotes{"F12"}.
