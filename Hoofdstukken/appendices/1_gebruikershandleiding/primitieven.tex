...
\begin{itemize}
	...
	\item alignment, de uitlijning van de te tekenen tekst. 
		\begin{itemize}
			...
			\item \type{Center}, het middelpunt van de tekst wordt op het punt uitgelijnd.
...
\begin{itemize}
	...
	\item \type{String}, het id van de \shape waarop gestopt werd met slepen \todo{Dit kan in een todo} \todo{Dit is al lang uit het protocol gesloopt geloof ik} {\color{red} WAT ALS GESTOPT WORD MET SLEPEN OP EEN SHAPE DIE DAAR NIET IN GEINTERESSERD IS, OF UBERHAUPT GEEN ID HEEFT?}
\end{itemize}
