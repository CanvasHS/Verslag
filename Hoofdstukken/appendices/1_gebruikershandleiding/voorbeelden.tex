...
Hierin is dus een \type{Event} shape toegevoegd voor onze cirkel, hierin wordt een eventId toegevoegd waar later naar gerefereerd kan worden. Daarnaast wordt vermeld dat deze shape ge\"interesseerd is in muisklikken. Als de muisklikken dan daadwerkelijk gebeurd wordt de tweede pattern van \inlinecode{handler} uitgevoerd, waar naast de \type{Event} ook nog een \type{Fill} over de cirkel toegepast wordt.
