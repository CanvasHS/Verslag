...
\subsection{Haskell}
Een uitbreiding op het protocol zal ook aan \todo{De haskell ook anders beschrijven}de Haskell-kant correct geïnterpreteerd en afgehandeld moeten worden. Eerst dient de API uitgebreid te worden met een nieuw data type. Dit zal gedaan moeten worden in de file \emph{Data.hs}.
